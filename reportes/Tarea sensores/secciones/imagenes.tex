...
\addcontentsline{toc}{subsubsection}{Encoder incremental}
...
\addcontentsline{toc}{subsubsection}{Encoder absoluto}
...
\begin{itemize}
	...
	\begin{figure}[h]
		...
		{%
			...
			\caption{LVDT \cite {lvdt_sensor_image}}
			\label{fig:lvdt}
		}
	\end{figure}
	...
	\begin{figure}[h]
		...
		{%
			...
			\caption{LVDT \cite{lvdt_secondary_coils_schematic}}
			\label{fig:lvdt2}
		}
	\end{figure}
...
\begin{figure}
	...
	\caption{Resólver \cite{servomotors_adjust_image}}
	\label{fig:resolver}
\end{figure}
...
\addcontentsline{toc}{subsubsection}{Sensores de posición}
...
%\begin{figure}
%	\centering
%	\includegraphics[width=0.4\linewidth]{img/tacometro}
%	\caption{Tacometro}
%	\label{fig:tacometro}
%\end{figure}
...
\addcontentsline{toc}{subsubsection}{Todos los sensores de fuerza}
...
\addcontentsline{toc}{subsubsection}{Galgas extensometricas}
...
\addcontentsline{toc}{subsubsection}{Sensor piezo electrico}
...
\begin{figure}[h]
	...
	\caption{Sensor piezoeléctrico \cite{piezoelectric_sensor_parts} \cite{piezoelectric_sensor}}
	\label{fig:mascotas}
\end{figure}
